...
URL = "https://damaged-jobi-noboking.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://damaged-jobi-noboking.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://damaged-jobi-noboking.koyeb.app/".format(FQDN)
else:
    URL = "https://damaged-jobi-noboking.koyeb.app/".format(FQDN)
